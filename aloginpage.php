  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link"  href="eloginpage.php">Employee Login</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="aloginpage.php" id="em">Admin Login</a>
        </li>
        ...
        <div class="card  text-black" >
          <div class="card-body p-4 text-center">
            ...
            <form action="aprocess.php" method="post">
              ...
              <button class="btn btn-outline-black bg-secondary btn-lg px-5 text-center" type="submit">Login</button>
